...
def get_unitree_l2_remappings() -> List[Tuple[str, str]]:
    ...
    remappings.append(('camera_0/color/image', '/image_raw'))
...
def add_nvblox(args: lu.ArgumentContainer) -> List[Action]:
    ...
    unitree_l2_colored_config = lu.get_path(
        'nvblox_examples_bringup',
        'config/nvblox/specializations/nvblox_unitree_l2_colored.yaml')
    ...
    if camera is NvbloxCamera.isaac_sim:
        ...
        camera_config = unitree_l2_colored_config if num_cameras > 0 else unitree_l2_config
